...
/**
 * Classe che dichiara il database locale in cui sono salvate le tabelle
 * identiche a quelle sul server. Le tabelle sono linea, tratta
 * e fermata.
 */
public class DatabaseLocale extends SQLiteOpenHelper {
    ...
    // Dichiarazione delle tabelle in linguaggio sql.
    ...
    // Getters delle variabili statiche che indicano i vari nomi di colonne e tabelle.
