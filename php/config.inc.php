...
# il sito da cui è stato preso spunto per il codice: http://forums.devshed.com/php-faqs-and-stickies-167/how-to-program-a-basic-but-secure-login-system-using-891201.html
	...
	// Tis is the way we saw in class, but I use a way founded in internet because
	...
	# mysql_select_db($dbname, $conn) or die("Database inesistente");
	 ...
	 // This is the way explained in the web
	 // http://www.mybringback.com/tutorial-series/12992/android-mysql-php-json-part-2-setting-up-a-xampp-server-and-mysql/
